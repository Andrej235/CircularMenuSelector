...
export class ItemDisplayImageMaterial extends ShaderMaterial {
  constructor() {
    super({
      uniforms: {
        u_time: { value: 0 },
        ...
        u_mouseRevealRadius: { value: 0.1 },
        u_mouseRevealRadiusSmoothFactor: { value: 2 },
      },
      transparent: true,
      vertexShader: `
                varying vec2 v_uv;
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      itemDisplayImageMaterial: Object3DNode<
        ItemDisplayImageMaterial,
        typeof ItemDisplayImageMaterial
      >;
    }
  }
}
